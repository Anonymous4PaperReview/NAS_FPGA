...
class NetworkManager:
    ...
    def get_rewards(self, model_fn, actions, time_performance, opt_performance):
        '''
        ...
        if opt_performance < time_performance:
            ...
            with tf.Session(graph=tf.Graph()) as network_sess:
                ...
                print("++++++++++++Reward Calculation:",acc,self.moving_acc,performance_reward)
                # compute the reward
